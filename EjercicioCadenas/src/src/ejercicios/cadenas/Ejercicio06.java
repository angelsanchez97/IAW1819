...
public class Ejercicio06 {
	...
	public static void main(String[] args) {
		String letraamorse = traducirAlfabeto("angelito eres tonto");
		System.out.print("Morse: ");
		System.out.println(letraamorse);
		String palabra = traducirMorse(letraamorse);
		System.out.print("Texto traduccido del Morse: ");
		System.out.println(palabra);
	}

	public static String traducirAlfabeto(String mensaje) {

		String letras = "abcdefghijklmnopqrstuvwxyz0123456789αινσϊ.,?!()[]&:;=+-_$@";
			...
			if (mensaje.charAt(i) == ' ')
				...
				for (int j = 0; j < letras.length(); j++) {
					if (mensaje.charAt(i) == letras.charAt(j))
						morse = morse + codigo[j] + ' '; // Poner el if si no
															// hay letras
				}
			}
		}
		return morse = morse.substring(1, morse.length());// quita el espacio
															// que se genera de
															// mas
	}
