...
public class EjercicioNueve {
	...
	// Leer por teclado una serie de n números. La aplicación debe indicarnos si 
	//los números están ordenados de forma creciente, decreciente o si no están ordenados
